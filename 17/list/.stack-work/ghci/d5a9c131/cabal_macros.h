...
/* package list-0.1.0.0 */
#define VERSION_list "0.1.0.0"
...
#define CURRENT_COMPONENT_ID "list-0.1.0.0-6z9kg7WyipYBQLwWzB6iqM"

#define CURRENT_PACKAGE_KEY "list-0.1.0.0-6z9kg7WyipYBQLwWzB6iqM"
